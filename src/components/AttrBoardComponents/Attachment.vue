<template>
  <div class="attr-board-container">
    ...
    <el-form :model="widget">
      ...
      >
        <el-input v-model.trim="widget.buttonText" :disabled="readonly || disableAttrs.includes('buttonText')" size="small" :maxLength="30" placeholder="请输入按钮文案" @blur="onTipsBlur"></el-input>
      </el-form-item>
    </el-form>
    <div class="attr-board-common-title">
      <span>描述</span>
    ...
    <span class="attr-board-common-title-tip">最大文件数9个，单个文件大小不超过20M</span>
  </div>
</template>
